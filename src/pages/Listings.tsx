        ...
        <section className="relative py-20 bg-gradient-to-br from-primary to-primary/80 overflow-hidden">
          ...
          <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-white/90 animate-slide-up">
              Examples of properties we've consulted on across Alberta
            </p>
          </div>
        </section>
        ...
        <section className="py-20 bg-background">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-16 text-center">
              <div className="bg-gradient-to-br from-primary to-primary/80 rounded-2xl p-12 shadow-xl">
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                  Ready to Find Your Perfect Property?
                </h2>
                <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                  Let Kraven Properties help you navigate Calgary and Edmonton's
                  real estate market with expert guidance and personalized
                  service.
                </p>
                <a
                  href="/#contact"
                  className="inline-block bg-white text-primary hover:bg-white/90 px-8 py-3 rounded-lg font-semibold shadow-lg transition-smooth"
                >
                  Get Started Today
                </a>
              </div>
