...
const ServicesSection = () => {
  const complianceServices = [
    ...
    },
    {
      ...
      description:
        "Consultation on safety plans, building codes, and regulatory documentation",
    },
    {
      icon: ClipboardList,
  ...
  const consultingServices = [
    ...
    },
    {
      ...
      description:
        "Vetted referrals to trusted contractors, plumbers, HVAC technicians, and marketing specialists",
    },
    {
      icon: Target,
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            From compliance strategy to investment optimization, we provide
            expert guidance to help you successfully navigate Alberta's property
            landscape.
          </p>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8 text-center">
                Navigate Alberta's complex property regulations with expert
                guidance. We help you understand and meet all municipal
                requirements for successful property ownership and operation.
              </p>
              ...
              <div className="grid gap-4">
                {complianceServices.map((service, index) => (
                  <Card
                    key={index}
                    className="shadow-card transition-smooth hover:shadow-lg border-0"
                  >
        ...
        <div>
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Maximize your success with expert guidance on investment strategy,
              operations, and optimization for your property portfolio.
            </p>
          </div>
